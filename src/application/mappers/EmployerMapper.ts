...
export class EmployerMapper {
  ...
  static toResponseDto(employer: IEmployer): EmployerResponseDto {
    return {
      ...
      phoneNumber: employer.mainPhone,
  ...
  static toDetailedResponseDto(employer: IEmployer): DetailedEmployerResponseDto {
    return {
      ...
      mobileNumber: employer.alternatePhone,
      faxNumber: employer.faxNumber,
      website: employer.website,
      address: {
        street: employer.headOfficeAddress,
        city: employer.city,
      ...
      billingAddress: {
        street: employer.mailingAddress,
        city: null,
        state: null,
        postalCode: null,
        country: null
      ...
      preferredCurrency: employer.currencies,
      ...
      certificationBody: employer.certifications,
      budgetAuthority: null,
      decisionMakingRole: employer.keyDecisionMakers,
      innovationIndex: employer.innovationIndex,
      notes: employer.publicNotes
    }
  }
